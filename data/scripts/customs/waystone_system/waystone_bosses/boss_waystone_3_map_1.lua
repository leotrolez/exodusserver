local config = {
    ...
    bossPosition = Position(32965, 33227, 7), 
    bossArea = {
        fromPos = Position(32960, 33224, 7), 
        toPos = Position(32974, 33239, 7), 
        entrancePos = Position(32965, 33236, 7), 
        exitPosition = Position(32369, 32241, 7) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(32875, 33200, 7),
        Position(32875, 33201, 7),
        Position(32875, 33202, 7),
        Position(32875, 33203, 7),
    },
    attempts = {
        level = 500, 
        storage = 720176, 
    ...
    createTeleportPos = Position(32972, 33229, 7), 
...
function astroBoss.onUse(player, item, fromPos, target, toPos, isHotkey)
    ...
    boss:registerEvent("frotreavermapOneDeath")
...
local creatureEvent = CreatureEvent("frotreavermapOneDeath")
