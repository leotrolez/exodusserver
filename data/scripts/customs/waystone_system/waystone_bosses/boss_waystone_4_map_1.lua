local config = {
    actionId = 42648, 
    bossName = "Rhazgor the Crimson Slayer",
    bossPosition = Position(33161, 33222, 7), 
    bossArea = {
        fromPos = Position(33150, 33216, 7), 
        toPos = Position(33177, 33236, 7), 
        entrancePos = Position(33159, 33234, 7), 
        exitPosition = Position(32369, 32241, 7) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(33209, 33240, 7),
        Position(33209, 33241, 7),
        Position(33209, 33242, 7),
        Position(33209, 33243, 7),
    },
    attempts = {
        level = 500, 
        storage = 720178, 
    ...
    createTeleportPos = Position(33153, 33227, 7), 
...
function astroBoss.onUse(player, item, fromPos, target, toPos, isHotkey)
    ...
    boss:registerEvent("rhazgorMapOneDeath")
...
local creatureEvent = CreatureEvent("rhazgorMapOneDeath")
