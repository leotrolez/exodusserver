local config = {
    actionId = 42653,
    bossName = "Nyxdrath the Midnight Terror",
    bossPosition = Position(33320, 33482, 7),
    bossArea = {
        fromPos = Position(33311, 33474, 7),
        toPos = Position(33329, 33491, 7),
        entrancePos = Position(33320, 33488, 7),
        exitPosition = Position(32369, 32241, 7)
    },
    participantsAllowAnyCount = true,
    participantsPos = {
        Position(33257, 33563, 7),
        Position(33256, 33563, 7),
        Position(33255, 33563, 7),
        Position(33254, 33563, 7),
    },
    attempts = {
        level = 500, 
        storage = 720183,
    ...
    createTeleportPos = Position(33315, 33477, 7),
...
function astroBoss.onUse(player, item, fromPos, target, toPos, isHotkey)
    ...
    boss:registerEvent("nyxdrathMapTwoDeath")
...
local creatureEvent = CreatureEvent("nyxdrathMapTwoDeath")
