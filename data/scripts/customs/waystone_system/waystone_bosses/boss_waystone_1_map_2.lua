local config = {
    ...
    bossPosition = Position(32982, 33415, 7), 
    bossArea = {
        fromPos = Position(32973, 33397, 7), 
        toPos = Position(33001, 33422, 7), 
        entrancePos = Position(32999, 33399, 7), 
        exitPosition = Position(32369, 32241, 7) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(32991, 33386, 7),
        Position(32992, 33386, 7),
        Position(32993, 33386, 7),
        Position(32994, 33386, 7),
    },
    attempts = {
        level = 500, 
        storage = 720173, 
    ...
    createTeleportPos = Position(32980, 33409, 7), 
...
function astroBoss.onUse(player, item, fromPos, target, toPos, isHotkey)
    ...
    boss:registerEvent("vorgrunMapTwoDeath")
...
local creatureEvent = CreatureEvent("vorgrunMapTwoDeath")
