local config = {
    ...
    bossPosition = Position(32951, 33344, 8),
    bossArea = {
        fromPos = Position(32941, 33330, 8),
        toPos = Position(32957, 33351, 8),
        entrancePos = Position(32950, 33333, 8),
        exitPosition = Position(32369, 32241, 7)
    },
    participantsAllowAnyCount = true,
    participantsPos = {
        Position(33024, 33270, 8),
        Position(33024, 33271, 8),
        Position(33024, 33272, 8),
        Position(33024, 33273, 8),
    },
    attempts = {
        level = 500, 
        storage = 720182,
    ...
    createTeleportPos = Position(32945, 33339, 8),
...
function astroBoss.onUse(player, item, fromPos, target, toPos, isHotkey)
    ...
    boss:registerEvent("nyxdrathMapOneDeath")
...
local creatureEvent = CreatureEvent("nyxdrathMapOneDeath")
