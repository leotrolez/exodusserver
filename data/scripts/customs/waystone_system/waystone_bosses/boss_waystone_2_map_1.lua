local config = {
    actionId = 42644, 
    bossName = "Fractalis the Shardmaw",
    bossPosition = Position(33423, 33103, 7), 
    bossArea = {
        fromPos = Position(33393, 33085, 7), 
        toPos = Position(33450, 33127, 7), 
        entrancePos = Position(33404, 33095, 7), 
        exitPosition = Position(32369, 32241, 7) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(33377, 33111, 7),
        Position(33376, 33111, 7),
        Position(33375, 33111, 7),
        Position(33374, 33111, 7),
    },
    attempts = {
        level = 500, 
        storage = 720174, 
    ...
    createTeleportPos = Position(33431, 33100, 7), 
...
function astroBoss.onUse(player, item, fromPos, target, toPos, isHotkey)
    ...
    boss:registerEvent("fractalismapOneDeath")
...
local creatureEvent = CreatureEvent("fractalismapOneDeath")
