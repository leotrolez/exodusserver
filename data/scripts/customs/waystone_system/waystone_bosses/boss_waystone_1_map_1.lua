local config = {
    actionId = 42642, 
    bossName = "Vorgrun of the Jade Fangs",
    bossPosition = Position(33366, 33088, 8), 
    bossArea = {
        fromPos = Position(33343, 33074, 8), 
        toPos = Position(33382, 33100, 8), 
        entrancePos = Position(33349, 33077, 8), 
        exitPosition = Position(32369, 32241, 7) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(33327, 33113, 8),
        Position(33327, 33114, 8),
        Position(33327, 33115, 8),
        Position(33327, 33116, 8),
    },
    attempts = {
        level = 500, 
        storage = 720172, 
    ...
    createTeleportPos = Position(33361, 33082, 8), 
...
function astroBoss.onUse(player, item, fromPos, target, toPos, isHotkey)
    ...
    boss:registerEvent("vorgrunMapOneDeath")
...
local creatureEvent = CreatureEvent("vorgrunMapOneDeath")
