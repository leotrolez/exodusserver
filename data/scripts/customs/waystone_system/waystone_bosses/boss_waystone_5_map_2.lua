local config = {
    actionId = 42651,
    bossName = "Morgrath the Umbral Archmage",
    bossPosition = Position(33117, 33028, 7),
    bossArea = {
        fromPos = Position(33109, 33007, 7),
        toPos = Position(33141, 33039, 7),
        entrancePos = Position(33131, 33014, 7),
        exitPosition = Position(32369, 32241, 7)
    },
    participantsAllowAnyCount = true,
    participantsPos = {
        Position(33213, 33080, 7),
        Position(33213, 33081, 7),
        Position(33213, 33082, 7),
        Position(33213, 33083, 7),
    },
    attempts = {
        level = 500, 
        storage = 720181,
    ...
    createTeleportPos = Position(33130, 33024, 7),
...
function astroBoss.onUse(player, item, fromPos, target, toPos, isHotkey)
    ...
    boss:registerEvent("morgrathMapTwoDeath")
...
local creatureEvent = CreatureEvent("morgrathMapTwoDeath")
