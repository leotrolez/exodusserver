local config = {
    actionId = 42647, 
    bossName = "Frostreaver the Glacialblade",
    bossPosition = Position(32965, 33083, 8), 
    bossArea = {
        fromPos = Position(32958, 33082, 8), 
        toPos = Position(32973, 33094, 8), 
        entrancePos = Position(32965, 33091, 8), 
        exitPosition = Position(32369, 32241, 7) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(32954, 33058, 8),
        Position(32954, 33059, 8),
        Position(32954, 33060, 8),
        Position(32954, 33061, 8),
    },
    attempts = {
        level = 500, 
        storage = 720177, 
    ...
    createTeleportPos = Position(32968, 33084, 8), 
...
function astroBoss.onUse(player, item, fromPos, target, toPos, isHotkey)
    ...
    boss:registerEvent("frotreavermapTwoDeath")
...
local creatureEvent = CreatureEvent("frotreavermapTwoDeath")
