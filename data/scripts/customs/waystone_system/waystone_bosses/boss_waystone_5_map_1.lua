local config = {
    ...
    bossPosition = Position(33462, 33350, 7), 
    bossArea = {
        fromPos = Position(33455, 33333, 7), 
        toPos = Position(33477, 33357, 7), 
        entrancePos = Position(33464, 33338, 7), 
        exitPosition = Position(32369, 32241, 7) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(33383, 33184, 7),
        Position(33383, 33185, 7),
        Position(33383, 33186, 7),
        Position(33383, 33187, 7),
    },
    attempts = {
        level = 500, 
        storage = 720180, 
    ...
    createTeleportPos = Position(33470, 33338, 7), 
...
function astroBoss.onUse(player, item, fromPos, target, toPos, isHotkey)
    ...
    boss:registerEvent("morgrathMapOneDeath")
...
local creatureEvent = CreatureEvent("morgrathMapOneDeath")
