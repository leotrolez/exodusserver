local config = {
    ...
    bossPosition = Position(33325, 33376, 8), 
    bossArea = {
        fromPos = Position(33312, 33373, 8), 
        toPos = Position(33328, 33379, 8), 
        entrancePos = Position(33313, 33376, 8), 
        exitPosition = Position(32369, 32241, 7) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(33282, 33425, 8),
        Position(33282, 33424, 8),
        Position(33282, 33423, 8),
        Position(33282, 33422, 8),
    },
    attempts = {
        level = 500, 
        storage = 720179, 
    ...
    createTeleportPos = Position(33326, 33374, 8), 
...
function astroBoss.onUse(player, item, fromPos, target, toPos, isHotkey)
    ...
    boss:registerEvent("rhazgorMapTwoDeath")
...
local creatureEvent = CreatureEvent("rhazgorMapTwoDeath")
