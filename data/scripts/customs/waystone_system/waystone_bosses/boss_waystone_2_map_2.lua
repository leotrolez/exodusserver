local config = {
    ...
    bossPosition = Position(33183, 33125, 8), 
    bossArea = {
        fromPos = Position(33173, 33118, 8), 
        toPos = Position(33192, 33136, 8), 
        entrancePos = Position(33185, 33133, 8), 
        exitPosition = Position(32369, 32241, 7) 
    },
    participantsAllowAnyCount = true, 
    participantsPos = {
        Position(33134, 33178, 8),
        Position(33134, 33179, 8),
        Position(33134, 33180, 8),
        Position(33134, 33181, 8),
    },
    attempts = {
        level = 500, 
        storage = 720175, 
    ...
    createTeleportPos = Position(33185, 33121, 8), 
...
function astroBoss.onUse(player, item, fromPos, target, toPos, isHotkey)
    ...
    boss:registerEvent("fractalismapTwoDeath")
...
local creatureEvent = CreatureEvent("fractalismapTwoDeath")
