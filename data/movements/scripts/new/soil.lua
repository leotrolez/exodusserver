local portals1 = {
	...
	[24544] = {position = Position(33183, 32198, 13), vocation = {1, 9}, storage = 10133} -- SORC + ILLUSIONIST
}
...
function onStepIn(creature, item, position, fromPosition)
	...
	if not portal or (type(portal.vocation) == "table" and not table.contains(portal.vocation, vocationId)) or (type(portal.vocation) == "number" and portal.vocation ~= vocationId) or player:getLevel() < 10 then
