local mType = Game.createMonsterType("Voidwagner")
local monster = {}
monster.description = "a Voidwagner"
...
monster.attacks = {
	{name ="melee", interval = 200, chance = 20, minDamage = -800, maxDamage = -1400, shootEffect = 66, effect = 285},
	{name ="combat", interval = 2000, chance = 13, type = COMBAT_ENERGYDAMAGE, minDamage = -850, maxDamage = -1700, range = 7, radius = 4, shootEffect = 57, effect = 271, target = true},
	{name ="combat", interval = 2000, chance = 17, type = COMBAT_HOLYDAMAGE, minDamage = -1500, maxDamage = -2000, range = 4, radius = 4, effect = 298, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_ARCANEDAMAGE, minDamage = -880, maxDamage = -1400, range = 7, shootEffect = 70, effect = 294, target = true},
	{name ="combat", interval = 2000, chance = 13, type = COMBAT_ICEDAMAGE, minDamage = -900, maxDamage = -1675, range = 4, radius = 4, effect = 282, target = false}
}
...
monster.elements = {
	...
	{type = COMBAT_ARCANEDAMAGE, percent = 45},
}
