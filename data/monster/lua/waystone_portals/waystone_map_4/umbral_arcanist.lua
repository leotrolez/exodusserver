local mType = Game.createMonsterType("Umbral Arcanist")
local monster = {}
monster.description = "a Umbral Arcanist"
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -750, maxDamage = -1800, effect = 1, range = 7, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_ARCANEDAMAGE, minDamage = -850, maxDamage = -2200, range = 3, length = 6, spread = 8, effect = 330, target = false},
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ARCANEDAMAGE, minDamage = -600, maxDamage = -2300, range = 3, length = 9, spread = 4, effect = 333, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_ARCANEDAMAGE, minDamage = -700, maxDamage = -1800, effect = 217, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_ARCANEDAMAGE, minDamage = -900, maxDamage = -1900, effect = 241, target = false}
}
