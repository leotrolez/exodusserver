...
ShootTypeNames shootTypeNames = {
	...
	{"waterarrow",	CONST_ANI_WATER_ARROW},
	{"arcanearrow",	CONST_ANI_ARCANE_ARROW},
	{"waterbolt",	CONST_ANI_WATER_BOLT},
	{"arcanebolt",	CONST_ANI_ARCANE_BOLT},
...
std::string getSkillName(uint8_t skillid)
{
	switch (skillid) {
		...
		case SKILL_HERBALIST:
			return "herbalist";

		case SKILL_ARMORSMITH:
			return "armorsmith";
		
		case SKILL_WEAPONSMITH:
			return "weaponsmith";

		case SKILL_JEWELSMITH:
			return "jewelsmith";
...
itemAttrTypes stringToItemAttribute(const std::string& str)
{
	...
	} else if (str == "unwrapid") {
		return ITEM_ATTRIBUTE_UNWRAPID;
