...
enum itemAttrTypes : uint32_t {
	...
	ITEM_ATTRIBUTE_RARITY = 1 << 27,
	ITEM_ATTRIBUTE_UNWRAPID = 1 << 28,
...
enum CombatType_t : uint16_t {
	...
	COMBAT_WATERDAMAGE = 1 << 12,
	COMBAT_ARCANEDAMAGE = 1 << 13,
...
enum ConditionParam_t {
	...
	CONDITION_PARAM_SKILL_CRAFTING = 56,
	CONDITION_PARAM_SKILL_CRAFTINGPERCENT = 57,
	CONDITION_PARAM_SKILL_WOODCUTTING = 58,
	CONDITION_PARAM_SKILL_WOODCUTTINGPERCENT = 59,
	CONDITION_PARAM_SKILL_MINING = 60,
	CONDITION_PARAM_SKILL_MININGPERCENT = 61,
	CONDITION_PARAM_SKILL_HERBALIST = 62,
	CONDITION_PARAM_SKILL_HERBALISTPERCENT = 63,
	CONDITION_PARAM_SKILL_ARMORSMITH = 64,
	CONDITION_PARAM_SKILL_ARMORSMITHPERCENT = 65,
	CONDITION_PARAM_SKILL_WEAPONSMITH = 66,
	CONDITION_PARAM_SKILL_WEAPONSMITHPERCENT = 67,
	CONDITION_PARAM_SKILL_JEWELSMITH = 68,
	CONDITION_PARAM_SKILL_JEWELSMITHPERCENT = 69
};
...
enum SpeechBubble_t
{
	...
	SPEECHBUBBLE_BOAT = 5,
	SPEECHBUBBLE_MISSION = 6,
	SPEECHBUBBLE_EXPEDITION = 7,
	SPEECHBUBBLE_DORN_REP = 8,
	SPEECHBUBBLE_FROST_REP = 9,
	SPEECHBUBBLE_HALLOW_REP = 10,
	SPEECHBUBBLE_VARDEN_REP = 11,
	SPEECHBUBBLE_VYRSK_REP = 12,
};
...
enum ItemTooltipAttributes_t : uint8_t {
	TOOLTIP_ATTRIBUTE_NONE = 0,
	TOOLTIP_ATTRIBUTE_ATTACK,
	TOOLTIP_ATTRIBUTE_DEFENSE,
	TOOLTIP_ATTRIBUTE_NAME,
	TOOLTIP_ATTRIBUTE_WEIGHT,
	TOOLTIP_ATTRIBUTE_ARMOR,
	TOOLTIP_ATTRIBUTE_HITCHANCE,
	TOOLTIP_ATTRIBUTE_SHOOTRANGE,
	TOOLTIP_ATTRIBUTE_DURATION,
	TOOLTIP_ATTRIBUTE_CHARGES,
	TOOLTIP_ATTRIBUTE_FLUIDTYPE,
	TOOLTIP_ATTRIBUTE_ATTACK_SPEED,
	TOOLTIP_ATTRIBUTE_RESISTANCES,
	TOOLTIP_ATTRIBUTE_STATS,
	TOOLTIP_ATTRIBUTE_SKILL,
	TOOLTIP_ATTRIBUTE_KEY,
	TOOLTIP_ATTRIBUTE_TEXT,
	TOOLTIP_ATTRIBUTE_WIELDINFO,
	TOOLTIP_ATTRIBUTE_COUNT,
	TOOLTIP_ATTRIBUTE_RUNE_LEVEL,
	TOOLTIP_ATTRIBUTE_RUNE_MAGIC_LEVEL,
	TOOLTIP_ATTRIBUTE_RUNE_NAME,
	TOOLTIP_ATTRIBUTE_CONTAINER_SIZE,
	TOOLTIP_ATTRIBUTE_SPEED,
	TOOLTIP_ATTRIBUTE_RARITY,
	TOOLTIP_ATTRIBUTE_FIELD_ABSORB,
	TOOLTIP_ATTRIBUTE_CRITICALHIT_CHANCE,
	TOOLTIP_ATTRIBUTE_CRITICALHIT_AMOUNT,
	TOOLTIP_ATTRIBUTE_MANA_LEECH_CHANCE,
	TOOLTIP_ATTRIBUTE_MANA_LEECH_AMOUNT,
	TOOLTIP_ATTRIBUTE_LIFE_LEECH_CHANCE,
	TOOLTIP_ATTRIBUTE_LIFE_LEECH_AMOUNT,
	TOOLTIP_ATTRIBUTE_INCREMENT_COINS,
	TOOLTIP_ATTRIBUTE_EXPERIENCE,
	TOOLTIP_ATTRIBUTE_FIRE_ATTACK,
	TOOLTIP_ATTRIBUTE_ENERGY_ATTACK,
	TOOLTIP_ATTRIBUTE_ICE_ATTACK,
	TOOLTIP_ATTRIBUTE_DEATH_ATTACK,
	TOOLTIP_ATTRIBUTE_EARTH_ATTACK,
	TOOLTIP_ATTRIBUTE_HOLY_ATTACK,
	TOOLTIP_ATTRIBUTE_WATER_ATTACK,
	TOOLTIP_ATTRIBUTE_ARCANE_ATTACK,
	TOOLTIP_ATTRIBUTE_EXTRADEFENSE,
	TOOLTIP_ATTRIBUTE_HEALTH_REGENERATE_ON_KILL_AMOUNT,
	TOOLTIP_ATTRIBUTE_HEALTH_REGENERATE_ON_KILL_CHANCE,
	TOOLTIP_ATTRIBUTE_MANA_REGENERATE_ON_KILL_AMOUNT,
	TOOLTIP_ATTRIBUTE_MANA_REGENERATE_ON_KILL_CHANCE,
};
...
enum ItemRarity_t : uint8_t {
	...
	ITEM_RARITY_ETERNAL,
	ITEM_RARITY_DIVINE,
	ITEM_RARITY_PHANTASMAL,
	ITEM_RARITY_CELESTIAL,
	ITEM_RARITY_COSMIC,
	ITEM_RARITY_ABYSSAL,
	ITEM_RARITY_TRANSCENDENT
};

struct TooltipData
{
	TooltipData(ItemTooltipAttributes_t id, int32_t value, int32_t type) : attributeId(id), attributeValue(value), attributeType(type) {}
	TooltipData(ItemTooltipAttributes_t id, int32_t value) : attributeId(id), attributeValue(value), attributeType(-1) {}
	TooltipData(ItemTooltipAttributes_t id, std::string value) : attributeId(id), attributeValue(value), attributeType(-1) {}

	bool isNumber() const { return attributeValue.type() == typeid(int32_t); }
	bool isString() const { return attributeValue.type() == typeid(std::string); }

	int32_t getNumber() const { return std::any_cast<int32_t>(attributeValue); }
	std::string getString() const { return std::any_cast<std::string>(attributeValue); }

	ItemTooltipAttributes_t attributeId;
	std::any attributeValue;
	int32_t attributeType; // Values such as SKILL_SWORD, COMBAT_FIREDAMAGE etc
};

typedef std::vector<TooltipData> TooltipDataContainer;
